...
public class CarrinhoDAO {
    ...
    public static List<Perfume> listarProdutos(int IDUsuario)
            throws SQLException, Exception {
        //Monta a string de listagem de produtos no banco, considerando
        //apenas a coluna de ativação de carrinho ("A")
        String sql = "SELECT PRODUTOS.ID,PRODUTOS.STATUS,PRODUTOS.TITULO,"
                ...
                + "CARRINHO.QUANTIDADE,PRODUTOS.DATACADASTRO,PRODUTOS.PESO,PRODUTOS.TAG"
    ...
    public static List<Perfume> listarProdutosPedido(int IDPedido)
            throws SQLException, Exception {
        //Monta a string de listagem de produtos no banco, considerando
        //apenas a coluna de ativação de carrinho ("A")
        String sql = "SELECT PRODUTOS.ID,PRODUTOS.STATUS,PRODUTOS.TITULO,"
                + "PRODUTOS.DESCRICAO,PRODUTOS.IMAGEM,PRODUTOS.IMAGEM1,PRODUTOS.IMAGEM2,PRODUTOS.VALORVENDA,PRODUTOS.VALORCUSTO,PRODUTOS.CATEGORIA,"
                + "CARRINHO.QUANTIDADE,PRODUTOS.DATACADASTRO,"
                + "PRODUTOS.PESO"

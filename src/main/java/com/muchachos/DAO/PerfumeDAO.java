...
import com.muchachos.MODELS.Perguntas;
...
public class PerfumeDAO {
    ...
    public static Perfume getByID(int ID)
        ...
        try {
            ...
            while (result.next()) {
                ...
                float Peso = result.getFloat("PESO");
                String Tag = result.getString("TAG");
                List<Perguntas> perguntas = getPerguntas(ID);
                ...
                Perfume P = new Perfume(IDperfume, Status, Titulo, Descricao, ValorVenda, ValorCusto, Categoria, Quantidade, Data, Imagem, Imagem1, Imagem2, Peso, Tag, perguntas);
    ...
    private static List<Perguntas> getPerguntas(int ID) throws SQLException, Exception {
        ...
        try {
            ...
            while (result.next()) {
                ...
                p.setResposta(result.getString("RESPOSTA"));
                perguntas.add(p);
            }
        }  catch (Exception e) {
            e.getLocalizedMessage();
